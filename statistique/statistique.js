...
if (userTemplates) {
    userTemplates.forEach(template => {
        selectOption += ` <option value="${template.url}"> ${template.name} </option>`
    });
...
wp.blocks.registerBlockType('give-xpert/statistique-block', {

    title: 'GiveXpert-statistique', // Block name visible to user
        ...
        return el('div',
            ...
            el(
                'button',
                {
                    ...
                    dataText: props.attributes.buttonLink,
                    // dataValue: props.attributes.buttonLink,
                    style: { 
